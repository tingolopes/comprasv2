...
def realizar_diagnostico_profundo():
    pastas_origem = [
        'temp_atas_arp', 'temp_compras_14133', 'temp_compras_legado',
        'temp_itens_14133_id', 'temp_itens_atas_id', 'temp_itens_legado_id',
        'temp_saldos_atas_id', 'temp_unidades_atas_id'
    ]
