    ...
    for id_item, fontes in mapa_fusao.items():
        ...
        reg = {
            ...
            (pncp.get("materialOuServicoNome") or
             ...
             ("" if e2.get("codigoItemMaterial") is None else "material") or
             ("" if e2.get("codigoItemServico") is None else "servico") or "").replace("Material", "material").replace("Serviço", "servico"),
